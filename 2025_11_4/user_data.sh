...
<body>
    <div class="container">
        <h1>Gotch ya</h1>
        <h2>This is waiting for you!!! Mel in the House</h2>
        
        <img src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExcWhqN2J3NWxxMHlqbWQ4Y3o0dmpqcHd3NWkyYXZpZjc0ZWw4NnNpdCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/AgTXXhw81sloI/giphy.gif" alt="yeahhhhhh" class="hero-image">
